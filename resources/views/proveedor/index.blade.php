            ...
            <form class="form" id="vendedores_filter" method="GET" action="{{route('proveedor.index')}}" >
                @method("GET")
                    <div class="row">
                            ...
                            <div class="col-12 col-md-4 form-box">
                                <input class="form-control " type="search" placeholder="Contacto" name="contacto" aria-label="contacto" value="{{$request->get('contacto')}}">
                            </div>
                            <div class="col-12 col-md-4 form-box">
                                <input class="form-control " type="search" placeholder="Email" name="email" aria-label="email" value="{{$request->get('email')}}">
                            </div>
                            <div class="col-12 col-md-4 form-box">
                                <input class="form-control " type="search" placeholder="Dirección" name="direccion" aria-label="direccion" value="{{$request->get('direccion')}}">
                            </div>
                            <div class="col-12 col-md-4 form-box">
                                <select name="activo">
                    ...
                    @foreach($proveedores as $proveedor)
                        <tr>
                            <td class="text-center">
                                ...
                                <a href="#" class="deleteProveedorRow" data-id="{{$proveedor->_id}}"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
