            ...
            <form class="form" id="proveedor_put" action="{{route('proveedor.update',$proveedor->_id)}}" method="POST" >
                ...
                <div class="row">
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="ID" name="_id" aria-label="_id" value="{{$proveedor->_id}}" disabled >
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Nombre" name="nombre" aria-label="nombre" value="{{$proveedor->nombre}}" >
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Nombre" name="nombre" aria-label="nombre" value="{{$proveedor->nombre}}" >
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Contacto" name="contacto" aria-label="contacto" value="{{$proveedor->contacto}}" >
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Email" name="email" aria-label="email" value="{{$proveedor->email}}">
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Dirección" name="direccion" aria-label="direccion" value="{{$proveedor->direccion}}" >
                    </div>
                    <div class="col-12 col-md-4 form-box">
