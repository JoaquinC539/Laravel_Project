            ...
            <form class="form" id="producto_post" action="{{route('producto.store')}}" method="POST" >
                ...
                <div class="row">
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Nombre" name="nombre" aria-label="nombre" required>
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="search" placeholder="Categoria" name="category" aria-label="category" required >
                    </div>
                    <div class="col-12 col-md-4 form-box">
                        <input class="form-control " type="number" placeholder="Precio" name="precio" aria-label="precio"  required>
                    </div>
                    <div class="col-12 col-md-4 form-box">
