...
@section('content')
    ...
    <br>
    <a href="/vendedor/create" style="color: rgb(241, 241, 241)"><button class="btn" style="color: antiquewhite"><i class="fa fa-plus"> </i>Nuevo Vendedor</button></a>
    <br>
    ...
    @push('scripts')
        <script type="module"  >
            'use strict';
            import { getTemplate,getData,tableBuilder,fetchDelete } from "/resources/js/globals.js";
